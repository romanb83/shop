...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var searchForm = document.querySelector('#search-form'),
      ...
      city = document.getElementById('city'); // const data = new FormData(searchForm);
  ...
  countries.addEventListener('change', function () {
    ...
    request.open('POST', urlRegion); // request.setRequestHeader('Content-type', 'application/json; charset=utf-8');
